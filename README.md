...
다음 구현은 Git remote/Vercel integration을 통한 자동 배포, production auth/SSO, 또는 더 깊은 admin workflow 중 하나로 나눌 수 있습니다. 기본 로컬/CI 경로는 계속 API key 없이 fake provider로 동작합니다.
